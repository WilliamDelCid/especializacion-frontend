...
export class HorizontaltopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private usuarioService:UsuarioService,@Inject(DOCUMENT) private document: any, private router: Router, private eventService: EventService, private authService: AuthenticationService,
