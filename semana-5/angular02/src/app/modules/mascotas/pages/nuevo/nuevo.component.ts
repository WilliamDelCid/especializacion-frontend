...
import { ServiceMascotaService } from '@modules/mascotas/services/service-mascota.service';
...
export class NuevoComponent implements OnInit {
  ...
  razas = [{ raza: 'Affenpinscher' }, { raza: 'Basenji' }, { raza: 'Pinscher' }, { raza: 'Pastor de Antolia' }, { raza: 'Pastor Ganadero' }, { raza: 'Silky Terrier' }, { raza: 'Chihuahua' }, { raza: 'Pinscher' }, { raza: 'Chow Chow' }, { raza: 'Afgano' }, { raza: 'Bóxer' }, { raza: 'King Charles Spaniel' }, { raza: 'Sabueso Bávaro de Montaña' }];
  origenes = [{ origen: 'África' }, { origen: 'Alemania' }, { origen: 'Australia' }, { origen: 'Afganistán' }, { origen: 'Chihuahua' }, { origen: 'Japonés' }, { origen: 'Medio Oriente' }, { origen: 'Mongolia' }, { origen: 'Desconocida' }];
  @Input() leyenda!: string;
  @Input() mascota!: IMascota;

  constructor(private mascotasService: ServiceMascotaService, private fb: FormBuilder, private toastr: ToastrService, private router: Router) {
